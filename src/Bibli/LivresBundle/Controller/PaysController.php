<?php
namespace Bibli\LivresBundle\Controller;
...
use Bibli\LivresBundle\Form\PaysType;
...
class PaysController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BibliLivresBundle:Pays')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BibliLivresBundle:Pays')->find($id);
     ...
     * @Method("POST")
     * @Template("BibliLivresBundle:Pays:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("BibliLivresBundle:Pays:edit.html.twig")
     */
